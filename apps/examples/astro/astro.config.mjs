...
// pipeline (#1008). The page reads the file in frontmatter and puts it on a <meta> a dev-only
// React island queries. A raw page `<script>` that `await import('@reticlehq/react')` 404s
// while Vite's dep cache is cold; the island loader already serves <Counter client:load />.
//
